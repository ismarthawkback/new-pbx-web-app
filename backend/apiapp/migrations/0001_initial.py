    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voicemail', models.CharField(blank=True, choices=[('yes', 'yes'), ('no', 'no')], max_length=3, null=True)),
            ],
            options={
                'db_table': 'ast_accbar',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('musiconhold', models.CharField(blank=True, max_length=20, null=True)),
                ('context', models.CharField(blank=True, max_length=20, null=True)),
                ('takecall', models.CharField(blank=True, max_length=1, null=True)),
                ('declinecall', models.CharField(blank=True, max_length=1, null=True)),
                ('call_from_prompt', models.CharField(blank=True, max_length=35, null=True)),
                ('norecording_prompt', models.CharField(blank=True, max_length=35, null=True)),
                ('options_prompt', models.CharField(blank=True, max_length=35, null=True)),
                ('hold_prompt', models.CharField(blank=True, max_length=35, null=True)),
                ('status_prompt', models.CharField(blank=True, max_length=35, null=True)),
                ('sorry_prompt', models.CharField(blank=True, max_length=35, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('friend', 'friend'), ('user', 'user'), ('peer', 'peer')], max_length=6, null=True)),
                ('context', models.CharField(blank=True, max_length=40, null=True)),
                ...
                ('transport', models.CharField(blank=True, choices=[('udp', 'udp'), ('tcp', 'tcp'), ('udp,tcp', 'udp,tcp'), ('tcp,upd', 'tcp,udp')], max_length=7, null=True)),
                ('dtmfmode', models.CharField(blank=True, choices=[('rfc2833', 'rfc2833'), ('info', 'info'), ('shortinfo', 'shortinfo'), ('inband', 'inband'), ('auto', 'auto')], max_length=9, null=True)),
                ('directmedia', models.CharField(blank=True, choices=[('yes', 'yes'), ('no', 'no'), ('nonat', 'nonat'), ('update', 'update')], max_length=6, null=True)),
                ...
                ('trustrpid', models.CharField(blank=True, choices=[('yes', 'yes'), ('no', 'no')], max_length=3, null=True)),
                ('progressinband', models.CharField(blank=True, choices=[('yes', 'yes'), ('no', 'no'), ('never', 'never')], max_length=5, null=True)),
                ...
                ('cc_agent_policy', models.CharField(blank=True, choices=[('never', 'never'), ('generic', 'generic'), ('native', 'native')], max_length=7, null=True)),
                ('cc_monitor_policy', models.CharField(blank=True, choices=[('never', 'never'), ('generic', 'generic'), ('native', 'native')], max_length=7, null=True)),
                ...
                ('session_timers', models.CharField(blank=True, choices=[('accept', 'accept'), ('refuse', 'refuse'), ('originate', 'originate')], db_column='session-timers', max_length=9, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('dir', models.CharField(max_length=255, primary_key=True, serialize=False)),
                ('msgnum', models.IntegerField()),
                ('context', models.CharField(blank=True, max_length=80, null=True)),
                ('macrocontext', models.CharField(blank=True, max_length=80, null=True)),
                ...
                ('mailboxuser', models.CharField(blank=True, max_length=30, null=True)),
                ('mailboxcontext', models.CharField(blank=True, max_length=30, null=True)),
